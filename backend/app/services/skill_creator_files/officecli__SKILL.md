...
`officecli` is **pre-installed** in the Clawith sandbox. You can call it directly in Python/Bash/Node.js code without any installation step.
...
result = officecli("create", "report.docx")
```

```bash
# Bash example
officecli create slides.pptx
officecli add slides.pptx / --type slide --prop title="Hello"
```
