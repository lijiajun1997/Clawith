...
BUILTIN_TOOLS = [
    ...
    },
    {
        ...
        "description": "Read office documents with intelligent structure analysis. Automatically converts to Markdown for future efficient searching. ALWAYS returns structure (headings, sheet names, page/row counts) first, then actual content. Smart pagination without duplicates.",
        "category": "file",
        "icon": "📑",
        "is_default": True,
        "parameters_schema": {
            ...
            "properties": {
                ...
                "sheet_name": {"type": "string", "description": "[Excel-only] Specific sheet name. If not specified, previews all sheets (first 200 rows, others 10 rows)."},
                "start": {"type": "integer", "description": "Start position (1-indexed). For PDF/Word/PPT: page number. For Excel: row number. Default: 1."},
                "count": {"type": "integer", "description": "Number of pages/rows to read (default: 50 pages for docs, 200 rows for Excel first sheet, 10 for others)."},
                "auto_convert": {"type": "boolean", "description": "Automatically convert entire document to Markdown and save to workspace/converted/ (default: true)."},
            },
            "required": ["path"],
        },
        "config": {},
    ...
    },
    {
        ...
        "description": "Search the internet using a configurable search engine. Supports DuckDuckGo (free), Tavily, Google, Bing, Zhipu (智谱), and Exa. Configure the search engine in the tool settings.",
        "category": "search",
        "icon": "🔍",
        "is_default": True,
        "parameters_schema": {
        ...
        "config_schema": {
            "fields": [
                ...
                },
                {
                    ...
                    "depends_on": {"search_engine": ["tavily", "google", "bing", "zhipu", "exa"]},
                },
                {
                    "key": "max_results",
    ...
    # --- File Conversion Tools ---
    {
        ...
        "description": "Convert a Markdown file to Word (.docx) or Excel (.xlsx). Supports tables, lists, code blocks, and rich text formatting. For Excel, level-1 headings create new sheets. **IMPORTANT: After conversion, if this is a deliverable for a user, you MUST call send_channel_file to send the actual file, NOT just report the file path.**",
        "category": "converter",
        "icon": "📄",
        "is_default": True,
        "parameters_schema": {
    ...
    # ── Unified Excel Advanced Tool ─────────────────────────────────────────────
    {
        ...
        "parameters_schema": {
            ...
            "properties": {
                ...
                "data": {"type": "array", "items": {"type": "array"}, "description": "2D array for write_range (e.g., [['A', 'B'], [1, 2]])"},
    ...
    # ── Unified Word Advanced Tool ──────────────────────────────────────────────
    {
        ...
        "parameters_schema": {
            ...
            "properties": {
                ...
                "data": {"type": "array", "items": {"type": "array"}, "description": "Table data (2D array)"},
