...
BUILTIN_TOOLS = [
    ...
    },
    {
        ...
        "description": "Read file contents from the workspace. Can read tasks.json, soul.md, memory/memory.md, skills/, and enterprise_info/. Use offset and limit for reading large files in chunks. Supports OCR for PDF and image files (.png, .jpg, .jpeg, .gif, .webp, .bmp, .tiff, .tif) to extract text from scanned documents. OCR results are automatically saved as Markdown files in workspace/converted/ for subsequent paginated reading.",
        "category": "file",
        "icon": "📄",
        "is_default": True,
        "parameters_schema": {
    ...
    },
    {
        ...
        "parameters_schema": {
            "type": "object",
            "properties": {
                "path": {"type": "string", "description": "Document file path, e.g.: workspace/knowledge_base/report.pdf, enterprise_info/knowledge_base/policy.docx"},
                "start": {"type": "integer", "description": "Start page (1-indexed, for PDF/Word/PPT) or row (for Excel). Default: 1."},
                "count": {"type": "integer", "description": "Number of pages/rows to read. Default: 50 for documents, 200 for Excel."},
                "max_chars": {"type": "integer", "description": "Maximum characters to return (default: 15000, max: 50000)."},
            },
            "required": ["path"],
        },
        "config": {},
