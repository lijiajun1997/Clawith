...
# Document tools
from app.services.word_document_server.tools.document_tools import (
...
# Content tools
from app.services.word_document_server.tools.content_tools import (
...
# Format tools
from app.services.word_document_server.tools.format_tools import (
    format_text, create_custom_style, format_table
)

# Protection tools
from app.services.word_document_server.tools.protection_tools import (
    protect_document, add_restricted_editing,
    add_digital_signature, verify_document
)

# Footnote tools
from app.services.word_document_server.tools.footnote_tools import (
    add_footnote_to_document, add_endnote_to_document,
    convert_footnotes_to_endnotes_in_document, customize_footnote_style
)

# Comment tools
from app.services.word_document_server.tools.comment_tools import (
