...
from app.services.word_document_server.utils.file_utils import ensure_docx_extension
from app.services.word_document_server.core.comments import (
...
async def get_comments_for_paragraph(filename: str, paragraph_index: int) -> str:
    ...
    try:
        ...
        from app.services.word_document_server.core.comments import get_comments_for_paragraph as core_get_comments_for_paragraph
