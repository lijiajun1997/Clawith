...
from app.services.word_document_server.utils.document_utils import find_and_replace_text, insert_header_near_text, insert_numbered_list_near_text, insert_line_or_paragraph_near_text, replace_paragraph_block_below_header, replace_block_between_manual_anchors
...
async def add_heading(filename: str, text: str, level: int = 1,
    ...
    Args:
        ...
        font_name: Font family (e.g., 'Helvetica', '微软雅黑')
...
async def add_paragraph(filename: str, text: str, style: Optional[str] = None,
    ...
    Args:
        ...
        font_name: Font family (e.g., 'Helvetica', 'Times New Roman', '微软雅黑')
